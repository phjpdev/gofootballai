...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-auto hidden border-t border-gray-90 bg-gray-100 lg:block">
      <div className="flex w-full flex-col gap-8 px-4 py-10 lg:mx-auto lg:max-w-6xl lg:px-8 lg:py-12">
